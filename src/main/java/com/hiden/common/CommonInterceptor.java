...
import com.hiden.utils.Constants;
import com.hiden.utils.CookieCheckUtils;
import com.hiden.utils.PhenixUserHander;
import com.hiden.utils.TokenUtil;
...
public class CommonInterceptor implements HandlerInterceptor {
    ...
    private static final List<String> pageAction = new ArrayList<String>();
        ...
        if (StringUtils.equals(BizConstants.H, namespace)) {
            ...
            if (pageAction.contains(actionName)) {
                ...
                if (!(StringUtils.isNotBlank(jtoken) && StringUtils.equals(token, jtoken))) {
                    ...
                    hidenVO.setCode(BizErrorEnum.APP_SECRET_ERROR.getCode());
                    hidenVO.setMsg(BizErrorEnum.APP_SECRET_ERROR.getMsg());
                    hidenVO.setStatus(0);
                    response.setContentType("application/json;charset=utf-8");
                    response.getWriter().write(JSON.toJSONString(hidenVO));
                    return false;
                }
            }
        }
