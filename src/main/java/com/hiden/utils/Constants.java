...
public class Constants {
    ...
    public static enum TradeType {
        ...
        dz_type((byte) 12, "定制"),
        scan_code_cash_type((byte) 13, "扫码中奖"),;
     ...
     * 众筹上下架状态
     */
    public static enum CrowdfundApproveStatus {
    	//众筹上下架状态(-1=下架完成;0=下架中;1=上架)
    	unLined((byte) -1, "下架完成"),
    	unLineIng((byte) 0, "下架中"),
    	onLine((byte) 1, "上架"),;
        ...
        CrowdfundApproveStatus(byte id, String name) {
            this.id = id;
            this.name = name;
        }
    ...
    public static final long POST_FEE = 1;
    //用户每天可摇的优惠券次数
