...
public class UpYunUtil {
	// 运行前先设置好以下三个参数
//		private static final String BUCKET_NAME = "ninelab";    
		private static final String BUCKET_NAME = "ninelab";    
		...
		public static final String UPYUN_URL = "http://ninelab.b0.upaiyun.com";
		...
		/** 不知道模块的根目录 */
		public static final String UNKNOWN_DIR_ROOT = "/module/hiden/";					//1
		...
		/** 肌肤测试根目录 */
		public static final String SKIN_CHECK_DIR_ROOT = "/module/skinCheck/";				//7
