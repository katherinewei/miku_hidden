...
//      }  
        ...
        hpDOExample.createCriteria().andMobileEqualTo(token.getUsername());
        List<ProfileDO> hpList = profileDOMapper.selectByExample(hpDOExample);
        if (null != hpList && hpList.size() > 0) {
            String pswd = hpList.get(0).getPassword();
