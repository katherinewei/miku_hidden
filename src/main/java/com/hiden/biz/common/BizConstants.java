...
public class BizConstants {
    ...
    public static final String COMPANY_NAME = "九研美尚";
    
    public static final String APP_NAME = "九研美尚";
    ...
    public static final String DEFAULT_ANNOUNCE = "欢迎进入九研美尚，购COOL，够实惠";
    ...
    public static final String EMCHAT_TEMP_CUSTOMER_PRE = "miku_temp_";	//环信临时客户用户名前缀
